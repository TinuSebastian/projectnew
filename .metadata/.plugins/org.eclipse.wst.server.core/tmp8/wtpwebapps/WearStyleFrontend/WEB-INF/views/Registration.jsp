...
body
{
    background: url('./resources/registration page.jpg') fixed;
	...
	<div class="row">
				<form action="reg" method="post">
					<div class="col-sm-12" >
						...
						<input type="text" placeholder="Enter Email Address Here.." pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="eg:tinu@gmail.com" name="Email" class="form-control"required>
					</div>
